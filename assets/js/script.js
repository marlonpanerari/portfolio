...
async function getAboutGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/marlonpanerari');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                ...
                <p>
                    ...
                    passando por transição de carreira.
                </p>
...
async function getProjectsGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/marlonpanerari/repos?sort=updated&per_page=6');
